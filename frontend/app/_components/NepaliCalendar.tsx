...
interface NepaliCalendarProps {
  ...
  onDateClick?: (bsDate: { year: number; month: number; day: number }) => void;
  onEventClick?: (event: CalendarEvent) => void;
  onAddEvent?: (date: { year: number; month: number; day: number }) => void;
  className?: string;
}
              ...
              >
                ...
                {onAddEvent && (
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      onAddEvent({ year: currentYear, month: currentMonth, day });
                    }}
